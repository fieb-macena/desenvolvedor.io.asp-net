...
VALUES (N'20260618195336_PrimeiraMigracao', N'10.0.9');

COMMIT;
GO

BEGIN TRANSACTION;
ALTER TABLE [PedidoItens] DROP CONSTRAINT [FK_PedidoItens_Produtos_ProdutoId];

ALTER TABLE [PedidoItens] ADD CONSTRAINT [FK_PedidoItens_Produtos_ProdutoId] FOREIGN KEY ([ProdutoId]) REFERENCES [Produtos] ([Id]) ON DELETE CASCADE;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260619112914_PrimeiraMigracaoV2', N'10.0.9');
